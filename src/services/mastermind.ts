import { Proof, PublicSignals, VerficationKey, VerficationKeyDatum } from "@/types/zk";
...
export class MastermindDatum {
  constructor(
    ...
    public vkey: VerficationKeyDatum,
  ) {
  ...
  public static fromCsl(datum: CSL.PlutusData) {
    ...
    // Create a Mastermind data object with empty values
    const vk_template: VerficationKeyDatum = {} as VerficationKeyDatum;
